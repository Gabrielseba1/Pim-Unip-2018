...
========================================================================*/
	string el, pl;
	int poltrona[22][18];
	int Caso_cadeira, i, j, n, fil = 19, col = 23, condi, x = 0, y = 0, l;
...
========================================================================*/
	...
	{ //tela de inicio 
		...
		printf("[3] - Sorteio\n\n");
		printf("[4] - Cadastro pessoa E-mail \n\n");
		printf("[5] - Login \n\n");
		printf("[0] - Fechar \n\n");
	...
	========================================================================*/
		...
		case 4:
			...
			do {
				...
				if (!confrm(p1, p2)) {
					printf("A Senha n confere, digite novamente");
				}
			} while (!confrm(p1, p2));
			size_t size = sizeof(pass[0]);
			pass[size + 1] = p1;
			Sleep(1000);
			break;
		case 5:
...
boolean confrm(string p1, string p2) {
	if (p1 == p2) {
		return true;
	}
	else {
